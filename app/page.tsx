...
// (Optional) SocialCard helper (kept here in case you reuse it later)
function SocialCard({
  label,
  tagline,
  href,
        ...
        <div className="container-tight py-14 grid md:grid-cols-2 gap-10 items-center relative">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a id="cta" href={ENV.DEX_BUY} target="_blank" rel="noopener noreferrer" className="btn-base">
                Buy $JIFF
              </a>
              <a href={ENV.CHART} target="_blank" rel="noopener noreferrer" className="btn-ghost">
                Chart
              </a>
            </div>
      ...
      <section id="token" className="container-tight py-12 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            <a href={ENV.DEX_BUY} target="_blank" rel="noopener noreferrer" className="btn-base">Buy on Base</a>
            <a href={ENV.CHART} target="_blank" rel="noopener noreferrer" className="btn-ghost rounded-xl">Chart</a>
          </div>
        </div>
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-6 auto-rows-fr items-stretch">
          ...
          <div className="card p-0 h-full flex flex-col">
            ...
            <div className="p-5 flex items-center gap-4 mt-auto">
              ...
              <div>
                <div className="font-semibold">YouTube • {ENV.STATS.YOUTUBE}+</div>
          ...
          >
            ...
            <div className="p-5 flex items-center gap-4 mt-auto">
              ...
              <div>
                <div className="font-semibold">Instagram • {ENV.STATS.INSTAGRAM}+</div>
          ...
          >
            ...
            <div className="p-5 flex items-center gap-4 mt-auto">
              ...
              <div>
                <div className="font-semibold">TikTok • {ENV.STATS.TIKTOK}+</div>
        ...
        <div className="mt-6 space-y-4">
          <details className="card p-5">
            ...
            <p className="mt-3 text-white/70">
              No. This is a based community fan token. Celebrating with the real most based Jiffpom.
            </p>
          </details>
          <details className="card p-5">
            <summary className="cursor-pointer font-semibold">Which chain?</summary>
            <p className="mt-3 text-white/70">
              Base Network. Coinbases layer 2 ETH chain. Low gas. Fast transaction speeds.
            </p>
          </details>
          <details className="card p-5">
            <summary className="cursor-pointer font-semibold">Taxes?</summary>
            <p className="mt-3 text-white/70">
              Fair launched on ape store with 0/0 taxes. Liquidity burnt.
            </p>
          </details>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 py-10 text-center text-white/60">
        <div className="container-tight">
          <div className="flex items-center justify-center gap-6 text-sm">
            <a href={ENV.X} target="_blank" rel="noopener noreferrer" className="link">X</a>
            <a href={ENV.TELEGRAM} target="_blank" rel="noopener noreferrer" className="link">Telegram</a>
            <a href={ENV.JIFF_LINKS.YOUTUBE} target="_blank" rel="noopener noreferrer" className="link">YouTube</a>
          </div>
          <div className="mt-4 flex items-center justify-center gap-3">
            <Image
              src="/images/footer-seal.png"
              alt="Community Fan Token • Built on Base"
              width={48}
              height={48}
              className="h-12 w-12"
            />
